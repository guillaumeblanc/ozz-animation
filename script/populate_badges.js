var myTableBadges = (function () {
  ...
  function populate_row(branch) {
    ...
    row += '<th><a href="https://github.com/guillaumeblanc/ozz-animation/actions/workflows/wasm.yml"><img src="https://github.com/guillaumeblanc/ozz-animation/actions/workflows/wasm.yml/badge.svg?branch=' + branch.name + '"></a></th>';
    row += '</tr>';
    return row;
  }
