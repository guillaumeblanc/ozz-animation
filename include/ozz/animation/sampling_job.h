...
#ifndef OZZ_OZZ_ANIMATION_SAMPLING_JOB_H_
#define OZZ_OZZ_ANIMATION_SAMPLING_JOB_H_
...
class SamplingCache {
 ...
 private:
  ...
  // time. If the _animation si different from the animation currently cached,
...
struct SamplingJob {
  ...
  // -if any input pointer is NULL or if output_end is less than output_begin.
  bool Validate() const;
  ...
  // Job output.
  // The range [output_begin,output_end[ to be filled with sampled joints
...
#endif  // OZZ_OZZ_ANIMATION_SAMPLING_JOB_H_
