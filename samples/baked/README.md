...
1. Description
This samples shows a physic simulation baked into an animation. Baking complex scenes into animations in a common technique to render cpu intensive simulations.
